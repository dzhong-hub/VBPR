function varargout = MatchWV3SamplesToS2ByNNP(varargin)
% MATCHWV3SAMPLESTOS2BYNNP MATLAB code for MatchWV3SamplesToS2ByNNP.fig
%      MATCHWV3SAMPLESTOS2BYNNP, by itself, creates a new MATCHWV3SAMPLESTOS2BYNNP or raises the existing
%      singleton*.
%
%      H = MATCHWV3SAMPLESTOS2BYNNP returns the handle to a new MATCHWV3SAMPLESTOS2BYNNP or the handle to
%      the existing singleton*.
%
%      MATCHWV3SAMPLESTOS2BYNNP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MATCHWV3SAMPLESTOS2BYNNP.M with the given input arguments.
%
%      MATCHWV3SAMPLESTOS2BYNNP('Property','Value',...) creates a new MATCHWV3SAMPLESTOS2BYNNP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MatchWV3SamplesToS2ByNNP_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MatchWV3SamplesToS2ByNNP_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MatchWV3SamplesToS2ByNNP

% Last Modified by GUIDE v2.5 08-Feb-2021 19:56:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MatchWV3SamplesToS2ByNNP_OpeningFcn, ...
                   'gui_OutputFcn',  @MatchWV3SamplesToS2ByNNP_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MatchWV3SamplesToS2ByNNP is made visible.
function MatchWV3SamplesToS2ByNNP_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MatchWV3SamplesToS2ByNNP (see VARARGIN)

% Choose default command line output for MatchWV3SamplesToS2ByNNP
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes MatchWV3SamplesToS2ByNNP wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MatchWV3SamplesToS2ByNNP_OutputFcn(hObject, eventdata, handles) 
...
[filename, pathname] = uigetfile( ...
 ...
 if  filename > 0  
    ...
    set(handles.txtOutputFileFolder, 'String', [pathname 'Matched']);
 end 
 cd(cur_dir);
...
if contains(s2_ref_file,'20m')
    outstr = '_20m_matched.tif';
elseif contains(s2_ref_file,'10m')
    outstr = '_10m_matched.tif';
else
