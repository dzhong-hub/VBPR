...
[Ox,Oy] = meshgrid(ss(1):ops(1):c*ops(1),...
    ss(2):ops(2):r*ops(2));
[Nx,Ny] = meshgrid(nn(1):nps(1):c*ops(1),...
    nn(2):nps(2):r*ops(2));

[Ox,Oy] = meshgrid((0.5:1:sx1-0.5)',...
                    (0.5:1:sy1-0.5)');
[Nx,Ny] = meshgrid((0.5*(sx1/sx2):sx1/sx2:sx1)',...
                    (0.5*(sy1/sy2):sy1/sy2:sy1)');
